...
var imported = zuacore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new zuacore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new zuacore.URI(paymentInfo).toString();
```
