 ...
 *
 * @param {string} prefix Network prefix. E.g.: 'zuatest'.
 */
...
const zuaNetworks = ['zua', 'zuadev', 'zuareg', 'zuatest', 'zuasim'];
...
zuaNetworks.map((str) => {
  addNetwork({
    ...
    privatekey: 0x80, // privatekey prefix -- must be 128 or toWIF() result will not match with zua
    scripthash: 0x05,
