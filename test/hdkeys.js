...
var HDPrivateKey = zuacore.HDPrivateKey;
var HDPublicKey = zuacore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = zuacore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(zuacore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(zuacore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      zuacore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = zuacore.PublicKey.fromPoint;
      zuacore.PublicKey.fromPoint = function() {
        zuacore.PublicKey.fromPoint = unstubbed;
