...
var BufferWriter = zuacore.encoding.BufferWriter;
var BufferReader = zuacore.encoding.BufferReader;
...
describe("Output", function() {
  ...
  it("#toObject roundtrip will handle an invalid (null) script", function() {
    ...
    var br = new zuacore.encoding.BufferReader(invalidOutputScript);
