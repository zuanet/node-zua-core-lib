...
var zuacore = require('../..');
var BN = zuacore.crypto.BN;
var Transaction = zuacore.Transaction;
var Signature = zuacore.Signature;
var Input = zuacore.Transaction.Input;
var Output = zuacore.Transaction.Output;
var PrivateKey = zuacore.PrivateKey;
var Script = zuacore.Script;
var Address = zuacore.Address;
var Networks = zuacore.Networks;
var Opcode = zuacore.Opcode;
var errors = zuacore.errors;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(zuacore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(zuacore.Script);
